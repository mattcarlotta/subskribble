...
const authQueries = {
  ...
  selectUserByKey: "SELECT * FROM users WHERE key=$1",
...
const notificationQueries = {
  ...
  getSomeNotifications: `
    ...
    `,
  selectNotificationByKey: "SELECT id FROM notifications WHERE key=$1",
...
const subQueries = {
  ...
  getSubscriberDetailsByEmail:
    "SELECT * FROM subscribers WHERE userid=$1 and email=$2",
