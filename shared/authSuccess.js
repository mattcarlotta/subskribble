module.exports = {
  ...
  removedAccountSuccess:
    'Your Subskribble account has been successfully removed. Thank you for using our services.',
  thanksForReg: (email, firstName, lastName) => ({
    message: `Thank you for registering, ${firstName} ${lastName}. Please check ${email} for a verification link.`,
  }),
  updatedAccount:
    'Successfully updated your account. You must reverify your email address before logging into your account again.',
