module.exports = app => ({
	...
	invalidPromo: "That promo code is invalid and/or can\'t be applied to the selected plan.",
	maxPromoUsage: "This promotional has reached its max amount of usage and is no longer valid. Please try another code instead.",
