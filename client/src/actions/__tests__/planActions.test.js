...
const activateplan = [{ ...mocked.inactiveplans[0], status: 'active' }];
const allactiveplans = [...activateplan, ...mocked.activeplans];
...
describe('Plan Actions', () => {
  ...
  describe('Fetch Plans Counts', () => {
    ...
    it('fetches initial and next record', async () => {
  ...
  describe('Updates Plan Status', () => {
    ...
    it('updates a plan record status', async () => {
