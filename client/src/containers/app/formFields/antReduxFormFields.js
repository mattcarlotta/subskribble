...
const AntFormFields = ({ FIELDS }) =>
  map(
    FIELDS,
    ({ component, className, selectOptions, style, ...props }, key) => (
...
const AntFormFieldsWithLabels = ({ FIELDS }) =>
  map(
    FIELDS,
    ({ component, className, label, selectOptions, style, ...props }, key) => (
...
const AntSelectField = ({
  ...
  <div className={className}>
    <Field {...props} component={AntSelect} hasFeedback={hasFeedback}>
      {selectOptions &&
