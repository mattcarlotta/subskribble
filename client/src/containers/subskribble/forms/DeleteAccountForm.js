...
class DeleteAccountForm extends Component {
	componentDidMount = () => this.props.initialize({ company: this.props.company, user: this.props.loggedinUser })
	...
	render = () => (
		<div className="new-form-container">
			<form onSubmit={this.props.handleSubmit(this.handleFormSubmit)}>
				...
				<div className="account-button-container" style={{ height: 90, padding: 20, marginBottom: 35 }}>
					<button
						type="submit"
						className={`ant-btn ${this.props.pristine ? "btn-disabled" : "btn-danger"}`}
					...
					<div className="delete-account-information">
						<p className="information">
							<span className="bold">Last chance! Deleting your account is <u>irreversible</u>.</span>
							<br />
