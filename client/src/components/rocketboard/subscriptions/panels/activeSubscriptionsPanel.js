...
import { ACTIVESUBSCRIPTIONS, TABLEHEADERS } from '../tables/subscriptionsData';
import ActiveSubscriptionsTable from '../tables/subscriptionsTable';
          ...
          >
            ...
            <CardText expandable={true}>
              <div className="panel-body">
                ...
                <FilterField
                  className="panel-4"
                  floatingLabelText="Filter Active Subscriptions"
                  form="FilterActiveSubscriptions"
                />
                <TableList TABLEBODYCONTENTS={() => ActiveSubscriptionsTable(ACTIVESUBSCRIPTIONS)} TABLEHEADERS={TABLEHEADERS} />
              </div>
            </CardText>
          </Card>
        </div>
