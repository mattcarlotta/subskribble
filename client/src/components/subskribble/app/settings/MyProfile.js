...
export default class Profile extends Component {
	...
	render = () => {
		const { avatarFormVisible } = this.state;
		return (
			<PageContainer>
				<div className="settings-container">
					...
					<div className="profile-picture">
						...
						{ !avatarFormVisible
							? <CurrentAvatar avatarURL={this.props.avatarURL} showAvatarForm={this.showAvatarForm} />
							: <UploadForm hideAvatarForm={this.hideAvatarForm} />
						}
					</div>
